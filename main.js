...
const options = {
  url: 'https://dev92497.service-now.com/',
  username: 'admin',
  password: 'gT8gKRpW1vrB'
};
...
function processRequestResults(error, response, body, callback) {
   ...
   */
   ...
   //console.log("DEBUG: processRequestResults(): isHibernating = " + isHibernating(response));
...
function sendRequest(callOptions, callback) {
  ...
  request(requestOptions, (error, response, body) => {
    processRequestResults(error, response, body, 
...
function get(callOptions, callback) {
  ...
  console.log("DEBUG: get(): sending request")
 ...
 */
function main() {
  //console.log("DEBUG: main(): Calling get")
  get({ serviceNowTable: 'change_request' }, (data, error) => {
    //console.log("DEBUG: main(): data = " + data)
  ...
  //console.log("DEBUG: main(): Calling post")
